        ...
        <div class="mt-10">
            <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                ...
                <form method="POST" action="#" class="lg:flex text-sm">
                    ...
                    <button type="submit"
                            class="transition-colors duration-300 bg-yellow-600 hover:bg-yellow-800 mt-4 lg:mt-0 lg:ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-8"
                    >
                        Subscribe
                    </button>
                </form>
